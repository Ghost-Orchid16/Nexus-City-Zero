...
export const CHARACTERS = [
  {
    ...
    weakness: 'Large interventions bring long-term trade-offs: +25% side effects and 30 s of public unrest',
    startBudget: 25,
    sideEffectMult: 1.25,
    majorDiscount: 0.75,
  ...
  },
  {
    ...
    weakness: 'Lower influence over healthcare and logistics (−20% health and supplies gains)',
    startBudget: 0,
    sideEffectMult: 1,
  ...
  },
  {
    ...
    strengths: ['+25% to transport and supply gains', 'Deliveries keep moving in a crisis (supplies resist failing roads)'],
